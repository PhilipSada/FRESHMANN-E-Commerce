                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="inputImageOne" type="text" class="inventory1 form-control form-control-lg @error('image_url_1') is-invalid @enderror" name="image_url_1" value="{{ old('image_url_1') }}" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="inputImageTwo" type="text" class="inventory2 form-control form-control-lg @error('image_url_2') is-invalid @enderror" name="image_url_2" value="{{ old('image_url_2') }}" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="inputPrice" type="text" class="inventory3 form-control form-control-lg @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="inputQuantity" type="text" class="inventory4 form-control form-control-lg @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" 
